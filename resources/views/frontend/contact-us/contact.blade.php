                ...
                <div class="service-sidebar">
                    <div class="sidebar-widget service-sidebar-single">
                        <div class="widget-box service-details-help bg-dark">
                            <div class="bg image"><img src="{{ asset('frontendAssets') }}/static_imges/details-bg.webp" alt="bg-image"></div>
                            <div class="service-details-content">
                                ...
                                <div class="help-contact">
                                    <div class="help-cta">
                                        ...
                                        <a href="mailto:info@ositbd.com" class="fav-button1" aria-label="Call now">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="h-5 w-5">
                    ...
                    <form>
                        <div class="row g-3">
                            ...
                            <div class="col-3">
                                ...
                                <a href="javascript:void(0)" class="fav-button1">
